...
import profilePix from '../public/images/My Passport.jpg';
...
const Hero = (props: Props) => {
  const [text, count] = useTypewriter({
    words: ['Hi, The name is Abdulmalik', 'The guy who likes to code', 'The guy who loves NextJS and TailwindCSS'],
    loop: true,
    delaySpeed: 2000,
  });
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden">
        ...
        />
        <div className="z-20">
          <h2 className="text-sm uppercase text-gray-300 pb-2 tracking-[12px]">Software Engineer</h2>
